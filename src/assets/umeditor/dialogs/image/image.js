...
//                }
  ...
  var Upload = {
    ...
    uploadComplete: function (r) {
      ...
      try {
        var json = eval('(' + r + ')');
        Base.callback(me.editor, me.dialog, json.data.filename, json.code === 0 ? 'SUCCESS' : 'Error');
      } catch (e) {
    ...
    submit: function (callback) {
      ...
      $(me.dialog).delegate(".edui-image-file", "change", function (e) {
        ...
        xhr.open("POST", me.editor.getOpt('imageUrl') + "&editorid=" + me.editor.id, true);
        xhr.setRequestHeader("Accept", "application/json, text/javascript");
        xhr.setRequestHeader("Authorization", readCookie("currentCompanyAuthorization"));
        xhr.onload = function (e) {
          var response = xhr.response; // not responseText
          me.uploadComplete(response);
        };
        xhr.send(fd);
